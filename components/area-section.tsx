    ...
    >
      <CardHeader className="pb-3 md:pb-4">
        <div className="flex items-center justify-between">
          ...
          <span
            className="text-sm md:text-base font-bold px-2 py-1 rounded-full"
            style={{
        ...
        {area.questions.map((question, qIndex) => {
          ...
          return (
            <div key={qIndex} className="space-y-3">
              <Label className="text-sm md:text-base font-semibold flex items-start gap-2 leading-relaxed">
                <span
                ...
                {([1, 2, 3, 4] as AnswerValue[]).map((value) => (
                  <label
                    ...
                    className={`
                      ...
                      px-4 py-3 md:py-2.5 rounded-xl border-2
                    ...
                    style={{
                      ...
                      background: currentValue === value
                        ...
                        : 'white',
                      minHeight: '48px', // Mínimo 48px para táctil
                      minWidth: '48px'
                    }}
                  >
                    <input
                      ...
                      className="sr-only" // Ocultar radio nativo
                    />
                    <div
                      className={`
