        ...
        <CardContent className="pt-16 pb-16">
          <div className="flex flex-col items-center justify-center space-y-5">
            ...
            <Button
              onClick={loadGroups}
              size="sm"
              className="h-10 px-6 font-bold shadow-lg hover:shadow-[0_0_15px_rgba(44,36,142,0.4)] transform hover:scale-105 transition-all duration-300 text-white"
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 relative z-10">
                ...
                <div className="flex gap-3">
                  <Button
                    ...
                    size="sm"
                    className="h-11 px-5 font-bold shadow-lg hover:shadow-[0_0_20px_rgba(44,36,142,0.4)] transform hover:scale-105 transition-all duration-300 text-white"
                    style={{ background: 'linear-gradient(135deg, #2C248E 0%, #8E235D 100%)' }}
                  >
