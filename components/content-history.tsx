...
export function ContentHistory({ contentId, fieldLabel, color = '#2C248E', onRestore }: ContentHistoryProps) {
    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-3" style={{ color }}>
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="mt-4 text-gray-600">No hay versiones anteriores</p>
              <p className="text-sm text-gray-500">Los cambios se guardarán automáticamente en el historial</p>
            </div>
          ) : (
            <div className="space-y-4">
              {history.map((entry, index) => (
                <div
                  ...
                  style={{ borderColor: index === 0 ? color : '#e5e7eb' }}
                >
      ...
      {previewContent && (
        <Dialog open={!!previewContent} onOpenChange={() => setPreviewContent(null)}>
          <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="bg-white rounded-lg p-6 border-2" style={{ borderColor }}>
            ...
            <div className="flex justify-end">
              <Button onClick={() => setPreviewContent(null)} variant="outline">
                Cerrar
              </Button>
            </div>
          </DialogContent>
